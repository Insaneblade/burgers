...
class Order extends React.Component {
    ...
    renderOrder = (key) => {
        ...
        if (!isAvailable) {
            ...
            return (<CSSTransition classNames="order" key={key} timeout={{ enter: 500, exit: 500 }}><li className="unavailable" key={key}>
        ...
        return (
            <div className="order-wrap">
                ...
                {total > 0 ? (
                    ...
                    <div className="nothingSelecterd">Выберите блюда и добавте к заказу</div>
                )}
            </div>
        )
    }
